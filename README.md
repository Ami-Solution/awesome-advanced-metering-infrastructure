...
.. image:: https://raw.githubusercontent.com/amisolution/ERC20-AMIS/master/images/amis-newlogo.png?format=1500w
    :height: 50 px
    :width: 150 px
    :scale: 50 %
    :alt: advanced metering infrastructure (AMI) logo
    :target: https://www.amisolution.net

The  `awesome advanced metering infrastructure (AMI) <https://ami-solution.github.io/awesome-advanced-metering-infrastructure/>`_ is acurated list of awesome advanced metering infrastructure frameworks, libraries and software it combines knowledge of utility planning and fluid systems engineering in an integrated framework. This
allows to study the effects, trade-offs and synergies of advanced metering infrastructure design options, utilities retrofits and energy saving infrastructure plans.
...
* Click `here <https://github.com/Ami-Solution/awesome-advanced-metering-infrastructure/issues>`__ to report an issue

# Awesome Advanced Metering Infrastructure [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)

A curated list of awesome advanced metering infrastructure frameworks, libraries and software (by language). Inspired by `awesome-php`.

If you want to contribute to this list (please do), send me a pull request.
Also, a listed repository should be deprecated if:

* Repository's owner explicitly say that "this library is not maintained".
* Not committed for long time (6~8 years).

Further resources:

* For a list of free advanced metering infrastructure books available for download, go [here](https://github.com/Ami-Solution/awesome-advanced-metering-infrastructure/blob/master/books.md).

* For a list of (mostly) free advanced metering infrastructure courses available online, go [here](https://github.com/Ami-Solution/awesome-advanced-metering-infrastructure/blob/master/courses.md).
...
* [hourly power consumption forecasting assumptions](https://www.kaggle.com/robikscube/tutorial-time-series-forecasting-with-prophet) -> source code and [dataset](https://www.kaggle.com/robikscube/tutorial-time-series-forecasting-with-prophet/data) for [Hourly Energy Consumption in megawatts](https://www.kaggle.com/robikscube/hourly-energy-consumption).
...
For V0.0.1 (stable):    |V0.0.1|


.. |V0.0.1| image:: https://zenodo.org/badge/DOI/12.1234/zenodo.1234567.svg
   :target: https://doi.org/12.1234/zenodo.1234567
