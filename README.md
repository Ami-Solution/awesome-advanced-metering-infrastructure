...
The advanced metering infrastructure index connects industrial partners and researchers from the utility and data science domains. We work together to understand smart metering data generated by utilities/operators/manufacturer. Literally billions of smart meter devices are installed in households/buildings/cities, but no one knows how to use all the data. 

Can we change that together ?
...
Partners receive educational content to help their staff learn how to process Smart Meter data from buildings outside of dataset.
...
* Click `here <http://ami-solution.github.io/en/latest/getting-started.html>`__  for installation manual and tutorials
...
<a name="javascript-amis"></a>
#### JavaScript Amis

* [node-modbus](https://github.com/Cloud-Automation/node-modbus)
* [rf-mesh-simulation](https://github.com/filmal2000/rfmesh)
...
* [node-modbus](https://github.com/Ami-Solution/node-modbus) - Node Modbus
